...
(
    ...
    CONSTRAINT FK_appointment_reports FOREIGN KEY (appointmentID) REFERENCES Appointments(AppointmentID),
    CONSTRAINT FK_patient_reports FOREIGN KEY (patientID)REFERENCES Patients(PatientID),
    CONSTRAINT FK_doctor_reports FOREIGN KEY (DoctorID) REFERENCES Doctors(DoctorID)
);
select * from Reports;
/******************************Feedback Table************************************************/
